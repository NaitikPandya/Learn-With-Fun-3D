 ...
 *
 */
public class sixobject extends Activity {

    // Used to handle pause and resume...
    private static sixobject master = null;
    ...
    class MyRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceChanged(GL10 gl, int w, int h) {
            ...
            if (master == null) {
                ...
                TextureManager.getInstance().addTexture("texture6", texture);
                try {
                    cube = Object3D.mergeAll(Loader.load3DS(getResources().getAssets().open("NUMBERS/6.3DS"), 1));
                } catch (IOException e) {
                    e.printStackTrace();
                }

 ...
 *
 */
public class busobject extends Activity {

    // Used to handle pause and resume...
    private static busobject master = null;
    ...
    class MyRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceChanged(GL10 gl, int w, int h) {
            ...
            if (master == null) {
                ...
                TextureManager.getInstance().addTexture("texturebus", texture);
                try {
                    cube = Object3D.mergeAll(Loader.load3DS(getResources().getAssets().open("VEHICLE/bus.3ds"), 1));
                } catch (IOException e) {
                    e.printStackTrace();
                }

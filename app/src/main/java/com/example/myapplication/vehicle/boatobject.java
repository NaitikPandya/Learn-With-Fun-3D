 ...
 *
 */
public class boatobject extends Activity {

    // Used to handle pause and resume...
    private static boatobject master = null;
    ...
    class MyRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceChanged(GL10 gl, int w, int h) {
            ...
            if (master == null) {
                ...
                TextureManager.getInstance().addTexture("textureboat", texture);
                try {
                    cube = Object3D.mergeAll(Loader.load3DS(getResources().getAssets().open("VEHICLE/boat.3ds"), 1));
                } catch (IOException e) {
                    e.printStackTrace();
                }

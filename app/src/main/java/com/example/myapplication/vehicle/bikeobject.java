 ...
 *
 */
public class bikeobject extends Activity {

    // Used to handle pause and resume...
    private static bikeobject master = null;
    ...
    class MyRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceChanged(GL10 gl, int w, int h) {
            ...
            if (master == null) {
                ...
                TextureManager.getInstance().addTexture("texturebike", texture);
                try {
                    cube = Object3D.mergeAll(Loader.load3DS(getResources().getAssets().open("VEHICLE/bike.3ds"), 5));
                } catch (IOException e) {
                    e.printStackTrace();
                }

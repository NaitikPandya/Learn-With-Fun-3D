 ...
 *
 */
public class horseobject extends Activity {

    // Used to handle pause and resume...
    private static horseobject master = null;
    ...
    class MyRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceChanged(GL10 gl, int w, int h) {
            ...
            if (master == null) {
                ...
                TextureManager.getInstance().addTexture("texturehorse", texture);
                try {
                    cube = Object3D.mergeAll(Loader.load3DS(getResources().getAssets().open("ANIMAL/Horse.3ds"), 1));
                } catch (IOException e) {
                    e.printStackTrace();
                }

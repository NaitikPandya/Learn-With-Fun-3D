 ...
 *
 */
public class pulsobject extends Activity {

    // Used to handle pause and resume...
    private static pulsobject master = null;
    ...
    class MyRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceChanged(GL10 gl, int w, int h) {
            ...
            if (master == null) {
                ...
                try {
                    cube = Object3D.mergeAll(Loader.load3DS(getResources().getAssets().open("plus.3DS"), 1));
                } catch (IOException e) {
                    e.printStackTrace();
                }

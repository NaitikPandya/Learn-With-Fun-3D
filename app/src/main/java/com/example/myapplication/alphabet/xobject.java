 ...
 *
 */
public class xobject extends Activity {

    // Used to handle pause and resume...
    private static xobject master = null;
    ...
    class MyRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceChanged(GL10 gl, int w, int h) {
            ...
            if (master == null) {
                ...
                TextureManager.getInstance().addTexture("texturex", texture);
                try {
                    cube = Object3D.mergeAll(Loader.load3DS(getResources().getAssets().open("ALPHABET/X.3DS"), 1));
                } catch (IOException e) {
                    e.printStackTrace();
                }

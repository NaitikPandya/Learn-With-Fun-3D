package com.example.myapplication.alphabet;
 ...
 *
 */
public class dobject extends Activity {

    // Used to handle pause and resume...
    private static dobject master = null;
    ...
    class MyRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceChanged(GL10 gl, int w, int h) {
            ...
            if (master == null) {
                ...
                TextureManager.getInstance().addTexture("textured", texture);
                try {
                    cube = Object3D.mergeAll(Loader.load3DS(getResources().getAssets().open("ALPHABET/D.3DS"), 1));
                } catch (IOException e) {
                    e.printStackTrace();
                }

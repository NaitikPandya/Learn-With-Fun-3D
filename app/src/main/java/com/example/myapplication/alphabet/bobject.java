 ...
 *
 */
public class bobject extends Activity {

    // Used to handle pause and resume...
    private static bobject master = null;
    ...
    class MyRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceChanged(GL10 gl, int w, int h) {
            ...
            if (master == null) {
                ...
                TextureManager.getInstance().addTexture("textureb", texture);
                try {
                    cube = Object3D.mergeAll(Loader.load3DS(getResources().getAssets().open("ALPHABET/B.3DS"), 1));
                } catch (IOException e) {
                    e.printStackTrace();
                }
